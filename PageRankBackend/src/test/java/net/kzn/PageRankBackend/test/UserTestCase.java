package net.kzn.PageRankBackend.test;
...
import net.kzn.PageRankBackend.dao.UserDAO;
...
public class UserTestCase {
	...
	public static void init() {
		...
		context.scan("net.kzn.PageRankBackend");
		context.refresh();
...
*/
	...
	public void testGetAddresses()
	{
		...
		assertEquals("Failed to fetch the list of the address and size doest not match",2,userDAO.listShippingAddresses(user).size());
		
		assertEquals("Failed to fetch the list of the address and size doest not match","Mumbai",userDAO.getBillingAddress(user).getCity());
